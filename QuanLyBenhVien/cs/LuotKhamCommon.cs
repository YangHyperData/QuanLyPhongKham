...
namespace QuanLyBenhVien
{
    public static class LuotKhamCommon
    {
        ...
        public static DataTable ThongKeKhamBenh(DateTime Tungay, DateTime DenNgay, decimal Loai)
        {
            return ConnectionSQL.GetDataTable("ThongKeKhamBenh", new object[] { Tungay, DenNgay, Loai });
        }
