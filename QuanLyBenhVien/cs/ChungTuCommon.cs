...
namespace QuanLyBenhVien
{
    public static class ChungTuCommon
    {
        ...
        public static DataTable ThongKeDoanhThu(DateTime Tungay, DateTime DenNgay, decimal Loai)
        {
            return ConnectionSQL.GetDataTable("ThongKeDoanhThu", new object[] { Tungay, DenNgay, Loai });
        }
        /// Update 
