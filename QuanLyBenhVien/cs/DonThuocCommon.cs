...
namespace QuanLyBenhVien
{
    public static class DonThuocCommon
    {
        ...
        public static DataTable ThongKeThuoc(DateTime Tungay, DateTime DenNgay, decimal Loai)
        {
            return ConnectionSQL.GetDataTable("ThongKeThuoc", new object[] { Tungay, DenNgay, Loai });
        }
