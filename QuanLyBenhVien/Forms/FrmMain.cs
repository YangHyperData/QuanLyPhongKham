...
namespace QuanLyBenhVien
{
    public partial class FrmMain : Form
    {
        ...
        private void thốngKêKhámBệnhToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void thốngKêKhámBệnhToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            fThongKeKhamBenh fr = new fThongKeKhamBenh();
            fr.TopLevel = false;
            AddTabPageNew(fr.Text, fr, 0);
        }

        private void thốngKêDoanhThuToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            fThongKeDoanhThu fr = new fThongKeDoanhThu();
            fr.TopLevel = false;
            AddTabPageNew(fr.Text, fr, 0);
        }

        private void thốngKêThuốcToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            fThongKeThuoc fr = new fThongKeThuoc();
            fr.TopLevel = false;
            AddTabPageNew(fr.Text, fr, 0);
        }
    }
